...
- **エンジン切替可能な設計** — GPT-SoVITS と Irodori-TTS の 2 エンジンを本番利用可、アドオン管理 UI からペルソナ別に切替可能
...
| Irodori-TTS | 約12秒(モデルロード含む) | 約1.4秒 (疑似ストリーミング) | ○ | 0.3〜0.35倍実時間 | 約2GB | 疑似ストリーミング対応(文単位チャンキング)、CUDA 必須 |
